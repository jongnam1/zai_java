...
public class JavaMethod3 {
	...
	static void findSubject(Courses[] arr) { //배열이 필요하니까 배열로 기재
	...
	public static void main(String[] args) {
		 ...
		 Courses[] course = new Courses[] { // <- 배열공간 만든것
		     new Courses(1, "정보사회와 컴퓨터", 3), // <-객체공간만들어지는것,생성자메서드 호출
   ...
   /* 메서드 정의를 위한 메서드 원형작성법
     ...
     4.다음 할일을 하기 위해 필요한거 돌려받기( 반환- return)
      - 물을 담아서 양동이를 전달하였다면 계속 일을하기위해
      - 빈 양동이를 다시 받아와야 한다.
      - 메서드가 정방향으로 데이터를 제공하는 방법이라면
